...
void DebugSystem::renderCollisionBoxes( entt::registry& registry, Window& window )
{
...
void DebugSystem::renderAttackRangeCircles( entt::registry& registry, Window& window )
{
    ...
    for ( auto entity : enemiesView )
    {
        ...
        attackCircle.setPosition(
            sf::Vector2f{ entityPosition.position.x - attackRange, entityPosition.position.y - attackRange } );
...
void DebugSystem::renderBackgroundTilesFrame( entt::registry& registry, Window& window,
