...
namespace utils
{
    inline bool isMouseOverSprite(const sf::Sprite& sprite, const Mouse::WorldCoords mouseWorldPosition )
    {
        sf::Vector2f localPosition = sprite.getInverseTransform().transformPoint(sf::Vector2f{ mouseWorldPosition.x, mouseWorldPosition.y });
    ...
    // TODO: temporary function for handling old stuff - REMOVE THIS
