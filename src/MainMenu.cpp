...
void MainMenu::initSettings()
{
    ...
    tabWindow
        ...
        .addTab( SettingsTab::Graphics, "Graphics",
            TabContentBuilder( contentStartPos, spacing )
                .addSettingSection( "Resolution" )
                .addStepSelector( []( int step ) { /* TODO: implement resolution change */ }, { "1920x1080", "2560x1440", "3840x2160" }, 0 )
                .addSettingSection( "VSync" )
                .addStepSelector( []( int step ) { /* TODO: implement VSync toggle */ }, { "OFF", "ON" }, 1 )
                .addSettingSection( "Quality" )
                .addStepSelector( []( int step ) { /* TODO: implement quality change */ }, { "LOW", "MID", "HIGH" }, 2 )
                .build()
        )
