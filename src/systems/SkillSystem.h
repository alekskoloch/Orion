...
public:
    ...
    static void addTripleShotWeaponSpecialShotEnergyCostMultiplier(entt::registry& registry, float multiplier);
    ...
    static void enableShieldChanceForTripleSpecialShot(entt::registry& registry);
